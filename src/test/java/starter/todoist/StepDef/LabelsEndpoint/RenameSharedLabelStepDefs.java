...
public class RenameSharedLabelStepDefs {
    ...
    public void postRenameSharedLabelWithValidJson() {
        File jsonValid1 = new File(Constant.JSON_REQUEST+"RenameLabel.json");
    ...
    public void postRenameSharedLabelWithInvalidJson() {
        File jsonInvalid = new File(Constant.JSON_REQUEST+"RenameLabel_Invalid.json");
    ...
    public void postRenameSharedLabelWithValidJsonWithInvalidToken() {
        File inv_token_json = new File(Constant.JSON_REQUEST+"RenameLabel.json");
    ...
    public void postRenameSharedLabelWithEmptyJson() {
        File empty_json = new File(Constant.JSON_REQUEST+"RenameLabel_empty.json");
