...
public class UpdateALabelStepDefs {
    ...
    public void updateALabelWithValidId(String id) {
        File validJson_label = new File(Constant.JSON_REQUEST+"/UpdateLabel/UpdateLabel.json");
    ...
    public void updateALabelWithValidIdButInvalidToken(String id) {
        File validJson_token = new File(Constant.JSON_REQUEST+"/UpdateLabel/UpdateLabel.json");
    ...
    public void updateALabelWithValidIdWithInvalidJson(String id) {
        File validJson_invalid = new File(Constant.JSON_REQUEST+"/UpdateLabel/UpdateLabel_invalid.json");
    ...
    public void updateALabelWithValidIdWithEmptyJson(String id) {
            File validJson_empty = new File(Constant.JSON_REQUEST+"/UpdateLabel/UpdateLabel_empty.json");
